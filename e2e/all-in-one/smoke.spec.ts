...
test.describe('All In One public smoke', () => {
  test('homepage loads with company name', async ({ page }) => {
...
test.describe('All In One portal smoke (demo)', () => {
  ...
  test('road ready page loads', async ({ page }) => {
    await page.goto(`${BASE}/portal/road-ready`);
    await expect(page.locator('.aio-app')).toBeVisible();
  });
});

test.describe('All In One office smoke (demo)', () => {
  ...
  test('QA command center loads', async ({ page }) => {
    await page.goto(`${BASE}/office/system/qa`);
  ...
  test('data health center loads', async ({ page }) => {
    await page.goto(`${BASE}/office/system/data`);
...
test.describe('route smoke — no crash', () => {
  const routes = [
    ...
    `${BASE}/get-started`,
    `${BASE}/office/crm`,
    `${BASE}/office/dispatch`,
    `${BASE}/office/management`,
    `${BASE}/office/security`,
  ];

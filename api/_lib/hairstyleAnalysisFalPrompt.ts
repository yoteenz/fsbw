  ...
  return [
    ...
    ...(tierKey === 'free'
      ? [
          ...
          'TOP MATCH panel footer: centered black Futura PT Medium; every-detail-matters build ribbon: centered gray Futura PT Medium.',
...
function freePromptFooter(analysis: FalHairstyleAnalysis): string {
  ...
  return [
    ...
    'TOP MATCH specs + every detail matters filled; centered **black** specs-locked footer + centered **gray** build ribbon; OVERALL SCORE % (red script) + MATCH RATING decimal in **gray Futura PT Medium** above **red** stars — **free tier only**.',

...
/** Sample variables for debug previews — realistic Frontal Slayer placeholders. */
...
export function allCatalogTemplateTypes(): EmailTemplateType[] {
  return EMAIL_TEMPLATE_CATEGORIES.flatMap((c) => c.templates.map((t) => t.type));
}

...
import { resolvePsaSeasonAccessForUser } from '../../_lib/psaSeasonAccess.js';
...
/** GET /api/education/season-access?seasonId= — normalized season entitlement resolution */
export default async function handler(req: VercelRequest, res: VercelResponse): Promise<void> {
  ...
  try {
    const access = await resolvePsaSeasonAccessForUser(supabase, user.id, seasonId);

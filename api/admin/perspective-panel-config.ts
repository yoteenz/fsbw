...
const CONFIG_KEY = 'perspective_panel_map';

/**
 * GET /api/admin/perspective-panel-config — founder read of perspective panel map.
 * PUT /api/admin/perspective-panel-config — founder upsert (cross-device sync).
 * Body: `{ version, revision, panels, updatedAt }`
 */

 ...
 * Admin-only: authenticate with email + password (Supabase), then return profile, orders, cart, wishlist
 * so the frontend can sync without relying on client-side getSession().

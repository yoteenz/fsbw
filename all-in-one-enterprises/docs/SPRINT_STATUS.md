...
Historical sprint documentation retained in this `docs/` folder from the Frontal Slayer host period. Route paths in older docs may reference `/all-in-one` — use `ROUTE_MIGRATION.md` for current paths.

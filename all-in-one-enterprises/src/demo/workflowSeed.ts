...
export const WORKFLOW_TEMPLATE_SLUGS = {
  ...
  ucrRegistration: 'ucr-registration',
  ucrRenewal: 'ucr-renewal',
  hvut2290: 'hvut-form-2290',
  mcs150Update: 'mcs-150-update',
  drugAlcoholConsortium: 'drug-alcohol-consortium',
  clearinghouseAssistance: 'clearinghouse-assistance',
  dqFileSetup: 'dq-file-setup',
  dqFileMaintenance: 'dq-file-maintenance',
  dotComplianceSupport: 'dot-compliance-support',
  dotAuditSupport: 'dot-audit-support',
  newEntrantAuditSupport: 'new-entrant-audit-support',
  eldService: 'eld-service',
  titleService: 'title-service',
  tagPlateService: 'tag-plate-service',
  payrollOnboarding: 'payroll-onboarding',
  taxPreparation: 'tax-preparation',
  safetyProgramEnrollment: 'safety-program-enrollment',

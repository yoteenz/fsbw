  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        required: true,
        options: [
          { value: 'not_formed', label: 'Not Formed Yet', description: 'Starting from scratch — AIO can help you form.' },
          { value: 'sole_proprietor', label: 'Sole Proprietor', description: 'Individual owner, simplest structure.' },
          { value: 'llc', label: 'LLC', description: 'Flexible structure with liability protection.' },
          { value: 'corporation', label: 'Corporation', description: 'Formal entity for growth and investment.' },
          { value: 'other', label: 'Other', description: 'Partnership or specialty entity type.' },
        ],
      },

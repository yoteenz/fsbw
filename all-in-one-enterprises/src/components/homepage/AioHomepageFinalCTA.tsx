...
export function AioHomepageFinalCTA() {
  ...
  const roadmapHref = hasProgress
    ...
    : aioGetStarted();
  const roadmapLabel = hasProgress ? 'Continue My Roadmap' : 'Start / Continue My Roadmap';

  return (
    <section className="aio-home-section aio-home-final-cta" aria-labelledby="aio-home-final-cta-heading">
      <div className="aio-home-final-cta__layout">
        <div className="aio-home-final-cta__copy">

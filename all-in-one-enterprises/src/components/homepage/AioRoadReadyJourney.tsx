      ...
      <div className="aio-home-roadmap__track" role="list" aria-label="Business lifecycle stages">
        ...
        {homepageRoadmapStages.map((stage) => (
          <Link
            key={stage.id}
            to={stage.href}
            className="aio-home-roadmap__stage"
            role="listitem"
          >
            <span className="aio-home-roadmap__stage-num">{stage.number}</span>
            <span className="aio-home-roadmap__stage-icon-wrap">
              <img src={getAioIconSrc(stage.iconKey)} alt="" className="aio-home-roadmap__stage-icon" width={28} height={28} />
            </span>
      ...
      <div className="aio-home-roadmap__prompt">
        {hasProgress ? (
          <>
            ...
            {journey.nextAction ? (
              <p className="aio-home-roadmap__prompt-next">
                Next step: {journey.nextAction.def.shortTitle} →
              </p>
            ) : null}
            <Link
              to={journey.nextAction?.ctaRoute ?? aioPaths.roadReady}
              className="aio-home-roadmap__prompt-cta"
            >
              Continue My Roadmap →
            </Link>
          </>

...
**Sprint:** STUDIO WORLD™ — The Civilization Layer™ (docs only)

---

## Purpose

Every idea, interaction, department, workflow, AI role, meeting, simulation, and design philosophy exists here as a **governed document** before any implementation.
...
**Read order:** Master Plan (where) → Knowledge Graph (connects) → Atlas (map) → Civilization (culture) → World Bible (feel) → Part 1 specs.
...
|----------|--------------|
| **[STUDIO_WORLD_CIVILIZATION_BIBLE.md](./STUDIO_WORLD_CIVILIZATION_BIBLE.md)** | **Cultural constitution** — Four Pillars · institutions · traditions · reputation · citizens · Chronicles · mythology · public spaces |
| **[STUDIO_WORLD_LIVING_KNOWLEDGE_GRAPH_BIBLE.md](./STUDIO_WORLD_LIVING_KNOWLEDGE_GRAPH_BIBLE.md)** | **Intelligence canon** — World Graph behavior · entity taxonomy · relationship model · Context Engine · Discovery Engine · subgraphs |
...
| **KG** | **[STUDIO_WORLD_LIVING_KNOWLEDGE_GRAPH_BIBLE.md](./STUDIO_WORLD_LIVING_KNOWLEDGE_GRAPH_BIBLE.md)** | **Living Knowledge Graph Bible** — entity taxonomy · relationship model · constellations · Context Engine · Discovery Engine · subgraphs · 10-phase roadmap |
| **CV** | **[STUDIO_WORLD_CIVILIZATION_BIBLE.md](./STUDIO_WORLD_CIVILIZATION_BIBLE.md)** | **Civilization Bible** — Four Pillars · cultural framework · institutions · citizens · reputation · traditions · public spaces · Chronicles · mythology · 10-phase roadmap |
...
| 004 | [AI_SPECIALISTS.md](./004_AI_SPECIALISTS.md) | Every permanent AI employee · behavior · disagreement |
| 005 | [FOUNDER_EXPERIENCE.md](./005_FOUNDER_EXPERIENCE.md) | Founder journey · executive operations |
| 006 | [MEETING_SYSTEM.md](./006_MEETING_SYSTEM.md) | Every meeting type · flow · chronicle |
| 007 | [WORLD_RULES.md](./007_WORLD_RULES.md) | Immutable operational laws |
| 008 | [WORLD_AMBIENCE.md](./008_WORLD_AMBIENCE.md) | Environmental behavior · continuous life |
| 009 | [INTERACTION_PRINCIPLES.md](./009_INTERACTION_PRINCIPLES.md) | Walk · enter · join · approve — not click |
| 010 | [IMPLEMENTATION_ROADMAP.md](./010_IMPLEMENTATION_ROADMAP.md) | Phases 0–6 · no rushed foundations |
...
Implementation begins only after founder approval of this specification layer.

...
| **Asset** | Any reusable visual, audio, prompt, template, file, material, environment, character, product image, video, or brand element. |

Canonical definitions: `src/studio-os/core/vocabulary.ts`

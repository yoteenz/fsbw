...
**Milestone:** M149 · **Volume:** volume-iv · **Module ID:** `predictive-qa`

**Route:** `/admin/studio/predictive-qa`

## Purpose

Predicts future quality risks.
...
| Layer | Path |
|-------|------|
| Module root | `src/studio-os-core/predictive-qa/` |

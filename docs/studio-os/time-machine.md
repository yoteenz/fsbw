...
**Milestone:** M148 · **Volume:** volume-iv · **Module ID:** `time-machine`

**Route:** `/admin/studio/time-machine`

## Purpose

Replays events, workflows, decisions, and AI actions.
...
| Layer | Path |
|-------|------|
| Module root | `src/studio-os-core/time-machine/` |

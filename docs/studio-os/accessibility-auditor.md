...
**Milestone:** M158 · **Volume:** volume-iv · **Module ID:** `accessibility-auditor`

**Route:** `/admin/studio/accessibility-auditor`

## Purpose

Evaluates inclusive, understandable, usable experiences.
...
|-------|-------|
| Canonical ID | `M158` |
| Internal ID | `accessibility-auditor` |
...
| Layer | Path |
|-------|------|
| Module root | `src/studio-os-core/accessibility-auditor/` |

...
**Milestone:** M157 · **Volume:** volume-iv · **Module ID:** `visual-diff-engine`

**Route:** `/admin/studio/visual-diff-engine`

## Purpose

Detects visual regressions against golden screenshots.
...
|-------|-------|
| Canonical ID | `M157` |
| Internal ID | `visual-diff-engine` |
...
| Layer | Path |
|-------|------|
| Module root | `src/studio-os-core/visual-diff-engine/` |

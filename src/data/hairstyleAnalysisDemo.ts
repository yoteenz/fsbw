...
const WHY_TWELVE = [
  "NOIR'S STRAIGHT TEXTURE AND JET BLACK LAYERS FRAME YOUR HEART-SHAPED FACE AND ALMOND-SHAPED EYES.",
  'SOFT WAVE OFF BLACK WITH LAYERS SOFTENS WIDTH AT YOUR FOREHEAD WHILE 26 INCH LENGTH BALANCES YOUR FACE.',
  'BLANCO PLATINUM WITH FLAT IRON ADDS COOL BLONDE CONTRAST AT YOUR EYES AND HIGH CHEEKBONES.',
  'OCEAN CURL CHERRY WITH DEFINE ADDS VOLUME AT YOUR CHEEKS TO BALANCE YOUR NARROWER CHIN.',
  'BEACH WAVE ESPRESSO WITH CRIMPS WARMS YOUR UNDERTONE WHEN JET BLACK READS TOO STARK ON YOUR SKIN.',
  'NOIR HONEY WITH LAYERS KEEPS A STRAIGHT SILHOUETTE THAT SUITS YOUR JAWLINE WHILE WARMING YOUR UNDERTONE.',
  'SOFT CURL COPPER WITH DEFINE HOLDS CURL ABOVE YOUR JAWLINE SO YOUR HEART SHAPE STAYS THE FOCUS.',
  'BLANCO ASH AT 20 INCH WITH FLAT IRON LIGHTENS AROUND YOUR FACE WITHOUT OVERPOWERING DELICATE FEATURES.',
  'SOFT WAVE GINGER WITH CRIMPS MATCHES WARMTH IN YOUR CHEEKS AND LIP TONE FOR A COHESIVE LOOK.',
  'BEACH WAVE GOLDEN WITH LAYERS WARMS THE HAIRLINE AGAINST YOUR SKIN WITHOUT COOL PLATINUM CONTRAST.',
];

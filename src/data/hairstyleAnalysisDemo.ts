...
const WHY_FREE = [
  'INSPO WAS LONG STRAIGHT BLACK — NOIR AT 24" IS THE DIRECT UNIT MATCH',
  'LAYERS KEEP THE BLUNT END FROM PULLING YOUR JAWLINE DOWN IN PHOTOS',
  'JET BLACK LINES UP WITH YOUR BROW SHADE IN THE SELFIE YOU SENT',
  'MIDDLE PART MATCHES HOW YOU PARTED YOUR HAIR IN THE REFERENCE IMAGE',
  '250% DENSITY MATCHES THE FULLNESS IN YOUR INSPO SCREENSHOT',
];

const WHY_TWELVE = [
  'TOP MATCH: NOIR 24" JET BLACK + LAYERS — CLOSEST TO YOUR INSPO REFERENCE',
  'ALT 1 SOFT WAVE OFF BLACK + LAYERS: 26" WAVY IF STRAIGHT FEELS TOO SHARP',
  'ALT 2 BLANCO PLATINUM + FLAT IRON: COOL BLONDE, SAME LENGTH AS TOP MATCH',
  'ALT 3 OCEAN CURL CHERRY + DEFINE: CURL TEXTURE WITH A VIBRANT COLOR TEST',
  'ALT 4 BEACH WAVE ESPRESSO + CRIMPS: WARM NEUTRAL IF JET BLACK WASHES YOU OUT',
  'ALT 5 NOIR HONEY + LAYERS: WARMER TONE ON THE SAME STRAIGHT TEXTURE',
  'ALT 6 SOFT CURL COPPER + DEFINE: RED FAMILY WITHOUT GOING AS BRIGHT AS CHERRY',
  'ALT 7 BLANCO ASH + FLAT IRON: COOLER BLONDE AT 20" FOR A SHORTER COMPARE',
  'ALT 8 SOFT WAVE GINGER + CRIMPS: ORANGE-RED CHECK ON YOUR UNDERTONE',
  'ALT 9 BEACH WAVE GOLDEN + LAYERS: GOLD BLONDE BETWEEN HONEY AND PLATINUM',
];

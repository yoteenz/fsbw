...
import { ExperienceLabFounderBriefRow } from './ExperienceLabFounderBriefRow';
...
export function ExperienceLabViewportStage({
  ...
  const founderBriefRow = <ExperienceLabFounderBriefRow model={model} isCompact={isCompact} />;
    ...
    <div className="elab-stage" {...{ [ELAB_V2_COMPOSITION.viewportStage]: '' }}>
      <div className="elab-stage__viewport-wrap">
        ...
        <StudioViewport
          ...
          stageOverlays={showFloats ? founderBriefRow : undefined}

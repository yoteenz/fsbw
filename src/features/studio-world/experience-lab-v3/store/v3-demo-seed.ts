...
export function createInitialV3State(): ExperienceLabV3State {
  ...
  return {
    ...
    activeAssetId: 'asset-bp-01',
    activeOutputId: 'blueprint',
    workOrders,
    ...
    workspaceMemory: {
      environment: {},
      production: { module: 'queue', workOrderId: 'wo-blueprint' },
      review: { comparisonMode: 'side-by-side', reviewItemId: 'rev-founder-01' },
      assets: { viewMode: 'grid', assetId: 'asset-bp-01' },

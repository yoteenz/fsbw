...
import type { DiagnosticRoutePath } from './paths';
...
function resolvePage(pathname: DiagnosticRoutePath): React.ComponentType {
...
export function mountIsolatedBlackBox(pathname: DiagnosticRoutePath): void {

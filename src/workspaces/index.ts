...
export function bootstrapWorkspacesPlatform(): void {
  void runWithStudioStorageBulkWrite(() => {
    ...
    const monetizationArchitecture = await import('../studio-os-core/monetization-architecture/bootstrap');
    ...
    const memoryEngine = await import('../studio-os-core/memory-engine/bootstrap');
    ...
    const shadowMode = await import('../studio-os-core/shadow-mode/bootstrap');
    ...
    const presenceEngine = await import('../studio-os-core/presence-engine/bootstrap');
    ...
    const autonomousPreparation = await import('../studio-os-core/autonomous-preparation/bootstrap');
    ...
    const innovationLab = await import('../studio-os-core/innovation-lab/bootstrap');
    ...
    const innovationLineage = await import('../studio-os-core/innovation-lineage/bootstrap');
    innovationLineage.bootstrapInnovationLineagePlatform();
    await yieldToMain();

    const innovationConstellations = await import('../studio-os-core/innovation-constellations/bootstrap');
    innovationConstellations.bootstrapInnovationConstellationsPlatform();
    await yieldToMain();

    const innovationExpeditions = await import('../studio-os-core/innovation-expeditions/bootstrap');
    innovationExpeditions.bootstrapInnovationExpeditionsPlatform();
    await yieldToMain();

    const worldAtlasMissionControl = await import('../studio-os-core/mission-control/bootstrap');
    worldAtlasMissionControl.bootstrapMissionControlPlatform();
    await yieldToMain();
    ...
    const studioFoundationModels = await import('../studio-os-core/studio-foundation-models/bootstrap');
    studioFoundationModels.bootstrapStudioFoundationModelsPlatform();
    await yieldToMain();

    const documentationSync = await import('../studio-os-core/documentation-sync/bootstrap');
    ...
    const documentationGovernance = await import('../studio-os-core/documentation-governance/bootstrap');
    ...
    const componentRegistry = await import('../studio-os-core/component-registry/bootstrap');
    ...
    const interactionEngine = await import('../studio-os-core/interaction-engine/bootstrap');
    ...
    const automationRegistry = await import('../studio-os-core/automation-registry/bootstrap');
    ...
    const permissionEngine = await import('../studio-os-core/permission-engine/bootstrap');
    ...
    const pluginSdk = await import('../studio-os-core/plugin-sdk/bootstrap');
    ...
    const experienceEngine = await import('../studio-os-core/experience-engine/bootstrap');
    experienceEngine.bootstrapExperienceEnginePlatform();
    await yieldToMain();
    ...
    const organizationalApprenticeship = await import('../studio-os-core/organizational-apprenticeship/bootstrap');
    ...
    const renderQueue = await import('../studio-os-core/render-queue/bootstrap');

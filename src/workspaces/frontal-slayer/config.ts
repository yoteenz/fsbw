...
export const FRONTAL_SLAYER_WORKSPACE: WorkspaceSchema = {
  ...
  moduleCopy: {
    ...
    'design-dna-canon': {
      subtitle:
        'PERMANENT DESIGN DNA — CANON PAGES · VISUAL RELATIONSHIPS · HEADQUARTERS REVIEW · PRESERVE MASTERPIECES · EVOLVE UNFINISHED SPACES.',
    },
    'design-genome': {
      subtitle:
        'ORGANIZATIONAL VISUAL MEMORY — PROMOTE APPROVED DESIGNS · INHERIT BEFORE BUILDING · INDEPENDENT GENOME PER ORGANIZATION.',
    },
    'creative-director': {

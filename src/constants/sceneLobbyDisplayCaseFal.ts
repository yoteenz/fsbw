...
export const LOBBY_DISPLAY_CASE_ON_SCENE_NEGATIVE =
  'frosted acrylic, opaque white case, cartoon, flat 2D overlay, studio gray void, green screen, wrong labels, missing register, case on shelves, case covering pedestals, duplicate case';

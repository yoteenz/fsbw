...
/** Dim layer on lobby slide — above scene hits, below open PNG ({@link LOBBY_CASE_PROP_OPEN_OVERLAY_Z_INDEX}). */
export const LOBBY_CASE_POPOVER_SCRIM_SLIDE_Z_INDEX = 27;
...
/** Phone glass panel above prop (px); lower = closer to asset. */
...
/** @deprecated Use `LOBBY_CASE_POPOVER_OPEN_Z_INDEX`. */
export const LOBBY_CASE_POPOVER_PANEL_Z_INDEX = LOBBY_CASE_POPOVER_OPEN_Z_INDEX;

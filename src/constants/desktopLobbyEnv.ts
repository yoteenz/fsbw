...
// Desktop Flagship Lounge — locked production background (lobby scroll zone + /desktop/lounge).
export const DESKTOP_LOUNGE_BG_URL =
  'https://hyycomvcaqxxvyrfupes.supabase.co/storage/v1/object/public/live-preview/Desktop/IMG_3567.png';
export const DESKTOP_LOUNGE_BG_FALLBACK = '/assets/marble%20bg.png';

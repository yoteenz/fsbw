...
export const LOBBY_SHELF_HIT_DEBUG_HD_LACE_OFFSET_Y_PX = 15;
export const LOBBY_SHELF_HIT_DEBUG_BUNDLES_OFFSET_Y_PX = 43;
export const LOBBY_SHELF_HIT_DEBUG_CUSTOM_UNITS_OFFSET_Y_PX = 72;

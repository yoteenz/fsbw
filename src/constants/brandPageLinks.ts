...
export const BRAND_INLINE_LINK_BY_SENTINEL: Record<string, BrandInlineLinkConfig> = {
  ...
  [BRAND_INLINE_LINK_MEMBER_SENTINEL]: {
    prefix:
      'YOU CAN BROWSE WITHOUT AN ACCOUNT, BUT CREATING ONE UNLOCKS ORDER TRACKING, WISHLIST, LOYALTY REWARDS, REFERRALS AND MEMBERS ONLY UPDATES. VISIT BECOME A MEMBER ',

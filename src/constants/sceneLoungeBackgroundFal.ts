...
import {
  ...
  LOUNGE_BACKGROUND_FAL_FIX_TRIM_CURRENT_OUTPUT,
  LOUNGE_BACKGROUND_FAL_FIX_TRIM_CURRENT_OUTPUT_NEGATIVE,
...
export const LOUNGE_BACKGROUND_FAL_EDIT = `${LOUNGE_BACKGROUND_FAL_THREE_PASS_NOTE} FIX CURRENT OUTPUT (3 baseboard ridges / ceiling panel): ${LOUNGE_BACKGROUND_FAL_FIX_TRIM_CURRENT_OUTPUT} FIX NEG: ${LOUNGE_BACKGROUND_FAL_FIX_TRIM_CURRENT_OUTPUT_NEGATIVE} TRIM MATCH: ${LOUNGE_BACKGROUND_FAL_LOBBY_TRIM_MATCH} TRIM NEG: ${LOUNGE_BACKGROUND_FAL_LOBBY_TRIM_MATCH_NEGATIVE} STEP A: ${LOUNGE_BACKGROUND_FAL_TRUE_RED_WALLS} CEILING SHORT: ${LOUNGE_BACKGROUND_FAL_CEILING_OUTPAINT_SHORT} LOBBY SYNC: ${LOBBY_BACKGROUND_FAL_WALLS_FROM_LOUNGE_REF} PASS 3: ${LOUNGE_BACKGROUND_FAL_PASS3_MID_BRIGHTEN} PASS 2: ${LOUNGE_BACKGROUND_FAL_PASS2_FRONT_LIGHT}`;

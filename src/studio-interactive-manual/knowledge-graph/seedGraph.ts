...
export const SEED_GRAPH_NODES: KnowledgeGraphNode[] = [
  ...
  },
  {
    ...
    type: 'module',
    description:
      'Immersive innovation headquarters — five connected architect studios, central collaboration forum, evolution wall, innovation lab, portfolio campus. The physical heart of Studio OS.',
    purpose: 'Companies designed inside creative environments · spatial navigation · not disconnected dashboards.',
    route: adminStudioArchitectStudioPath(),
    moduleId: 'architect-studio',
    relatedManualChapter: 'CHAPTER · ARCHITECT STUDIO · INNOVATION HEADQUARTERS',
    versionIntroduced: 'Milestone 58',
    status: 'demo',
    searchKeywords: ['architect studio', 'innovation campus', 'collaboration forum', 'evolution wall', 'innovation lab', 'portfolio campus', 'spatial navigation'],
  },
  {

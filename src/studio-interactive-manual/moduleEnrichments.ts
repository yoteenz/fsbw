...
export const MODULE_MANUAL_ENRICHMENTS: Record<string, ModuleManualEnrichment> = {
  ...
  'studio-intelligence': {
    ...
    relatedModuleIds: ['memory-bible', 'knowledge-hub', 'growth-network', 'labs', 'marketplace', 'business-model-engine', 'governance', 'ecosystem', 'talent-network', 'ai-media-network'],
  },
  'content-packs': {

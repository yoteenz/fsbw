...
const CLIENT_PHOTO_RULES =
  'CLIENT PHOTO = BACKGROUND-REMOVED CUTOUT ON MARBLE, BOTTOM-ANCHORED IN PANEL (NOT CENTERED). SYMMETRICAL BOTTOM FADE TO TRANSPARENT MARBLE. NO STUDIO/TAN BACKDROP.';

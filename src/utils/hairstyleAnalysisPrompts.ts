...
const CLIENT_PHOTO_RULES =
  'CLIENT PHOTO = ONE IN-PLACE FULL-BLEED PORTRAIT IN THE PANEL WINDOW (SINGLE LAYER). EDIT HAIR ONLY. NO CUTOUT, NO INSET FRAME, NO SECOND PORTRAIT ON TOP. SERVER APPLIES BOTTOM FADE TO MARBLE AFTER GENERATION.';
...
DO NOT REDRAW ROSE ICONS. OVERALL SCORE = #EB1C24 COVERED BY YOUR GRACE HANDWRITTEN SCRIPT (~50PX MAX, COMPACT IN PANEL). STARS = EMBOSSED GRADIENT RED GLYPH (PINK-CORAL CENTER → BRAND RED, DARK-RED OUTLINE).
CLIENT PILL = RED "TOP MATCH". BLACK HEADER = CLIENT FIRST + LAST NAME.
${CLIENT_PHOTO_RULES}
TOP MATCH + SPECS + EVERY DETAIL MATTERS LINES (VERBATIM FROM MANIFEST — CHANGE WHEN SPECS CHANGE). MATCH SCORE % = GRAY #808080.`,
...
SCORE #EB1C24 COVERED BY YOUR GRACE HANDWRITTEN SCRIPT COMPACT IN PANEL; STARS = EMBOSSED GRADIENT RED GLYPH. PRESERVE ALL ROSE ICONS PIXEL-PERFECT.
CLIENT PILL = RED "TOP MATCH". BLACK HEADER = CLIENT FIRST + LAST NAME.
${CLIENT_PHOTO_RULES}
TOP MATCH + 3 ADDITIONAL MATCHES (UNIT, COLOR, LENGTH, SCORE%). MATCH SCORE % = GRAY #808080 ONLY.`,
...
ERASE ANY TIER SUBTITLE — CLIENT MUST NOT SEE ANALYSIS TYPE.
SCORE #EB1C24 COVERED BY YOUR GRACE HANDWRITTEN SCRIPT COMPACT IN PANEL; STARS = EMBOSSED GRADIENT RED GLYPH. PRESERVE ROSE ICONS.
CLIENT PILL = RED "TOP MATCH". BLACK HEADER = CLIENT FIRST + LAST NAME.
${CLIENT_PHOTO_RULES}

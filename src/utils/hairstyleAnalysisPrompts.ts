...
TOP MATCH + 3 ALTERNATIVES (UNIT, COLOR, LENGTH, SCORE%). MATCH THUMBNAILS = SAME CLIENT FACE + MANNEQUIN TEXTURE.
...
STYLE PORTFOLIO 01–07 (TOP + 6 ALTS). PORTFOLIO THUMBNAILS = SAME CLIENT + MANNEQUIN TEXTURE.
...
FULL TOP MATCH + 9 ALTERNATIVES + SPECS PANEL + 10 WHY LINES. ALT THUMBNAILS = SAME CLIENT + MANNEQUIN TEXTURE.

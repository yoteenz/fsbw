...
export const BCF_COLOR_OPTIONS: BcfColorOption[] = [
  { id: 'JET BLACK', label: 'JET BLACK', price: 100, swatch: '#000000' },
  { id: 'OFF BLACK', label: 'OFF BLACK', price: 0, swatch: '#2A2424' },
  { id: 'ESPRESSO', label: 'ESPRESSO', price: 100, swatch: '#3B1301' },
  { id: 'CHESTNUT', label: 'CHESTNUT', price: 100, swatch: '#6C2D11' },
  { id: 'HONEY', label: 'HONEY', price: 100, swatch: '#C58628' },
  { id: 'AUBURN', label: 'AUBURN', price: 100, swatch: '#9C5617' },
  { id: 'COPPER', label: 'COPPER', price: 100, swatch: '#802F02' },
  { id: 'GINGER', label: 'GINGER', price: 100, swatch: '#F64F07' },
  { id: 'SANGRIA', label: 'SANGRIA', price: 100, swatch: '#7E0A1E' },
  { id: 'CHERRY', label: 'CHERRY', price: 100, swatch: '#D70808' },
  { id: 'RASPBERRY', label: 'RASPBERRY', price: 100, swatch: '#EF0461' },
  { id: 'PLUM', label: 'PLUM', price: 100, swatch: '#640E82' },
  { id: 'COBALT', label: 'COBALT', price: 100, swatch: '#290481' },
  { id: 'TEAL', label: 'TEAL', price: 100, swatch: '#46EBCA' },
  { id: 'SLIME', label: 'SLIME', price: 100, swatch: '#03D92A' },
  { id: 'CITRINE', label: 'CITRINE', price: 100, swatch: '#E2E91C' },

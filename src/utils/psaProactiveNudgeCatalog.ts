...
export function getPsaProactiveNudgeCatalog(): PsaNudgeCatalogCategory[] {
  const catalog: PsaNudgeCatalogCategory[] = [
      ...
      entries: [
        {
          ...
          headline: 'SIGN YOUR ORDER AUTHORIZATION FORM',
      ...
      entries: [
        {
          ...
          priority: 5,
          pageContexts: ['orders'],
          headline: 'SHE IS OFFICIALLY IN MOTION',
        ...
        },
        {
          ...
          priority: 5,
          pageContexts: ['orders'],
          headline: 'SHE IS ON HER WAY TO YOU',
          body: SAMPLE.orderNumber,
    ...
    },
    {
      ...
      label: 'Hall of Slay milestone',
      description: 'One-time member recognition from psaSlayJournal.ts.',
      sortOrder: 6,
      entries: [
        {
          variantId: 'member_milestone.first_order',
          kind: 'member_milestone',
          variantLabel: 'First order',
          priority: 6,
          pageContexts: ['general', 'orders'],
          headline: 'YOUR SLAY JOURNEY STARTED',
          body: 'THIS IS A MOMENT WORTH REMEMBERING.',
          prefilledMessage: 'Celebrate my first order milestone and tell me what is smart to do next.',
          actionLabel: 'VIEW JOURNAL',
          actionPath: '/account',
        },
        {
          variantId: 'member_milestone.black_status',
          kind: 'member_milestone',
          variantLabel: 'BLACK status',
          priority: 6,
          pageContexts: ['general'],
          headline: 'BLACK STATUS UNLOCKED',
          body: 'TOP TIER ACCESS AND CURATOR ENERGY.',
          prefilledMessage: 'I just hit BLACK status. What should I know about my perks?',
          actionLabel: 'VIEW REWARDS',
          actionPath: '/account/rewards',
        },
        {
          variantId: 'member_milestone.fifth_order',
          kind: 'member_milestone',
          variantLabel: 'Fifth order',
          priority: 6,
          pageContexts: ['orders'],
          headline: 'FIFTH ORDER MILESTONE',
          body: 'A TRUE ROTATION SLAYER.',
          prefilledMessage: 'Celebrate my fifth order milestone with me.',

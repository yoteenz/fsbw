...
export const ADMIN_STUDIO_MODULES: readonly AdminStudioModule[] = [
  // OVERVIEW
  {
    ...
    route: '/admin/studio/world/command-center',
    groupId: 'overview',
    status: 'demo',
    metric: 'HQ',
    ctaLabel: 'ENTER HQ',
  ...
  },
  {
    ...
    purpose: 'Professional economy — Professional Licenses™, Career Expansions™, ceremonies, mentor economy, legacy businesses.',
    route: p('studio-exchange'),
    groupId: 'intelligence',
    status: 'live',
    metric: 'E05',
    ctaLabel: 'ENTER STUDIO EXCHANGE',
  ...
  },
  {
    ...
    title: 'DIGITAL TWIN™',
    purpose: 'Complete sandbox replica — Studio Intelligence tests automations, workflows, brains, and integrations before production.',
  ...
  },
  {
    ...
    route: p('knowledge-registry'),
    groupId: 'intelligence',
    status: 'live',
    metric: 'M126',
    ctaLabel: 'OPEN KNOWLEDGE REGISTRY',
    moduleKey: 'knowledge-registry',
    featuredOnOverview: true,
  },
  {
  ...
  {
    id: 'studio-warehouse',
    title: 'STUDIO ARCHIVES™',
    purpose:
      'Flagship Studio World™ headquarters — Grand Entrance™, Orientation Atrium™, Warehouse Wing™, Museum™, Innovation™, Genome Vault™, Blueprint Archive™, Marketplace Pavilion™.',
    route: '/admin/studio/world/archives',
    groupId: 'visuals',
    status: 'live',
    metric: 'IMMERSIVE',
    ctaLabel: 'ENTER ARCHIVES',
  ...
  },
  {
    id: 'studio-museum',
    title: 'MUSEUM WING™',
    purpose: 'Legacy wing inside Studio Archives™ — Golden Builds™, Legacy Hall™, Memory Sphere™, Replay Mode™.',
    route: '/admin/studio/world/archives?zone=museum-wing',
    groupId: 'visuals',
    status: 'live',
    metric: 'LEGACY WING',
    ctaLabel: 'ENTER MUSEUM WING',
  ...
  },
  {
    ...
    route: '/admin/studio/world/expedition-hub',
    groupId: 'settings',
    status: 'demo',
    metric: 'M89',
    ctaLabel: 'EXPAND HQ',

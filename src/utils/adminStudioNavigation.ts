...
export const ADMIN_STUDIO_MODULES: readonly AdminStudioModule[] = [
  ...
  },
  {
    ...
    purpose: 'Studio World™ parent campus — walk production galleries, Museum Legacy Wing™, and Hall of Innovation™ without leaving the building.',
  ...
  },
  {
    id: 'studio-museum',
    title: 'STUDIO MUSEUM™',
    purpose: 'Legacy Wing inside Studio Warehouse™ — Golden Builds™, Legacy Hall™, Memory Sphere™. Walk from production into history.',
    route: p('studio-warehouse') + '?zone=museum-wing',
    groupId: 'visuals',
    status: 'live',
    metric: 'LEGACY WING',

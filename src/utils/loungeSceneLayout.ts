...
/** Lounge salon chairs: restored viewport-centered placement (see `LoungePage` scoped CSS). */
...
/** Extra downward nudge on large screens only (added to offset above). */
export const LOUNGE_SALON_CHAIRS_LARGE_EXTRA_Y_PX = 52;

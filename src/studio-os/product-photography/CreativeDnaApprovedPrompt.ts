/**
 * Approved Photography Prompt — Frontal Slayer Signature Collection Master Product Photography System.
 * Prompt Version v2.0 · Creative DNA v1.0 · Status: Approved / Locked
 *
 * FULL production recipe for Master Hero Portrait generation. Do not summarize or truncate.
 */

export const CREATIVE_DNA_APPROVED_PROMPT_NAME =
  'Frontal Slayer Signature Collection Master Product Photography System' as const;

export const CREATIVE_DNA_APPROVED_PROMPT_VERSION = 'v2.0' as const;

/** Complete prompt body — immutable under Creative DNA v1.0. */

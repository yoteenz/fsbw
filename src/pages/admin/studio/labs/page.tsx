...
import { LabsWorkspace } from '../../../../components/admin/studio/labs/LabsWorkspace';
import {
...
export default function AdminStudioLabsPage() {
  const navigate = useNavigate();

  return (
    <AdminStudioStageShell
      title="STUDIO OS LABS"
      subtitle={ADMIN_STUDIO_LABS_SUBTITLE}
    ...
    >
      <div className="p-3 mb-4 border" style={{ background: ADMIN_STUDIO_THEME.panelBg, borderColor: ADMIN_STUDIO_THEME.panelBorder }}>
        <p className="text-[7px] font-futura uppercase mb-2" style={{ fontWeight: 515, color: ADMIN_STUDIO_THEME.textSecondary }}>
          LEARNING ENGINE · NOT ANALYTICS · AI MEDIA = FIRST WORKSPACE · EVERY PUBLISH = EXPERIMENT
        </p>
        <div className="flex flex-col items-center gap-0">
          {LABS_INHERITANCE_CHAIN.map((step, i) => (
            <div key={step} className="w-full flex flex-col items-center">
              ...
              <div
                ...
                style={{
                  fontWeight: 515,
                  color: step === 'EXPERIMENT ENGINE' ? ADMIN_STUDIO_THEME.accent : ADMIN_STUDIO_THEME.textSecondary,
                  background: step === 'EXPERIMENT ENGINE' ? ADMIN_STUDIO_THEME.selectedBg : 'rgba(255,255,255,0.6)',
      ...
      <div className="flex gap-2 mt-4">
        <button
          type="button"
          onClick={() => navigate('/admin/studio/vision-engine')}
      ...
      <AdminStudioDisclaimerFooter>
        STUDIO OS LABS V1.0 · EXPERIMENT ENGINE · DEMO DATA · AI MEDIA PILOT · CONNECTORS NOT CONNECTED
      </AdminStudioDisclaimerFooter>
    </AdminStudioStageShell>
  );
}

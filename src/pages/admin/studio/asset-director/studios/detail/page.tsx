...
export default function AdminStudioAssetDirectorStudioDetailPage() {
  ...
  const [quickPreview, setQuickPreview] = useState<{ name: string; previewSrc: string; resolution?: string; version?: string } | null>(null);
  ...
  return (
    <AdminStudioStageShell
      ...
      hideNavTabs
    >
      <AssetDirectorStudioDetailView bundle={bundle} onQuickPreview={setQuickPreview} />

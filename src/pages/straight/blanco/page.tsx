              ...
              <div style={{ display: 'inline-flex', flexDirection: 'column', alignItems: 'stretch' }}>
                ...
                <div style={{ position: 'relative', width: '100%', marginBottom: '4px', transform: 'translateY(0)', minHeight: 'clamp(18px, 2.2vw, 26px)' }}>
                  <p 
                    ...
                    style={{ position: 'absolute', left: 'clamp(4px, 1vw, 12px)', top: '0', color: '#909090', fontFamily: '"Futura PT Demi"', fontSize: '10px', fontWeight: '600', margin: '0', cursor: 'pointer', userSelect: 'none', whiteSpace: 'nowrap' }}
                  >
                  ...
                  <div className="flex flex-col" style={{ height: 'clamp(290px, 72.5vw, 464px)', justifyContent: 'space-between', gap: 'clamp(6px, 1.2vw, 12px)' }}>
                    <div className="flex-shrink-0 relative">
                      <div
                        ...
                        style={{ width: 'clamp(100px, 26vw, 175px)', height: 'clamp(140px, 36vw, 245px)', backgroundImage: `url('${is3DView ? current3DImages.top : '/assets/NOIR/leaf-brick.png'}')`, backgroundSize: 'cover', backgroundPosition: is3DView ? 'center calc(50% + 5px)' : 'center', backgroundRepeat: 'no-repeat' }}
                    ...
                    <div className="flex-shrink-0 relative">
                      <div
                        className="relative bg-cover bg-center flex items-center justify-center cursor-pointer"
                        style={{ width: 'clamp(100px, 26vw, 175px)', height: 'clamp(140px, 36vw, 245px)', backgroundImage: `url('${is3DView ? current3DImages.bottom : '/assets/NOIR/leaf-brick.png'}')`, backgroundSize: 'cover', backgroundPosition: is3DView ? 'center calc(50% + 5px)' : 'center', backgroundRepeat: 'no-repeat' }}

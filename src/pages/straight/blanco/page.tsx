...
<div style={{ transform: `translateX(${cartCount === 0 ? 7 : 5}px)` }}>
            ...
            <div className="product-wig-preview" style={{ width: '100%', display: 'flex', alignItems: 'center', flexDirection: 'column', marginBottom: '24px', transform: 'translateY(20px)', overflow: 'visible', minWidth: '100%', maxWidth: 'none' }}>
              ...
              <div style={{ display: 'inline-flex', flexDirection: 'column', alignItems: 'stretch' }}>
                ...
                <UnitPdpWigPreviewImages
                  ...
                  heroFrameBackgroundImage={`url('${is3DView ? current3DImages.hero : '/assets/leaf-brick-resize.png'}')`}
                  topThumbBackgroundImage={`url('${is3DView ? current3DImages.top : '/assets/leaf-brick-resize.png'}')`}
                  bottomThumbBackgroundImage={`url('${is3DView ? current3DImages.bottom : '/assets/leaf-brick-resize.png'}')`}
                  onOpenHeroViewer={() => {
          ...
          <UnitPdpCartActions
            ...
            onTryFree={() => navigate(getBawTryRouteForUnitSlug('blanco'))}

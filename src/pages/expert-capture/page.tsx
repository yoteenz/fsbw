...
import {
  ...
  EXPERT_CAPTURE_FUTURE_PLACEHOLDERS,
  loadMediaBlob,
...
export default function ExpertCapturePage() {
  const cap = useExpertCaptureSession();
    ...
    return (
      <div style={styles.page}>
        <div style={styles.container}>
          <p style={{ fontSize: 13, color: '#a3a3a3', margin: '0 0 8px' }}>Studio Institute</p>
          <h1 style={styles.h1}>Expert Capture</h1>
          <p style={styles.sub}>
            Teach Studio OS through conversation — one question at a time. You remain the authority; the AI is your
            apprentice.
          </p>
          <div style={styles.card}>
            <label style={{ display: 'block', fontSize: 13, marginBottom: 6, color: '#525252' }}>Your name</label>
            <input style={styles.input} value={name} onChange={(e) => setName(e.target.value)} placeholder="Expert name" />
            <label style={{ display: 'block', fontSize: 13, marginBottom: 6, color: '#525252' }}>Your role / expertise</label>
            <input style={styles.input} value={role} onChange={(e) => setRole(e.target.value)} placeholder="e.g. Master Stylist" />
            <Btn primary disabled={!name.trim()} onClick={() => cap.startSession(name, role)}>
              Begin Expert Capture Session
            </Btn>
          </div>
        </div>
      </div>
        ...
        <div style={styles.container}>
          ...
          <div style={styles.card}>
            <p style={{ margin: '0 0 12px', lineHeight: 1.6 }}>
              <strong>Purpose:</strong> Capture your professional knowledge to train Studio OS apprentices.
            </p>
            <p style={{ margin: '0 0 12px', lineHeight: 1.6 }}>
        ...
        <div style={styles.container}>
          ...
          <details style={{ marginTop: 24 }}>
            ...
            <ul style={{ fontSize: 13, color: '#a3a3a3', paddingLeft: 18 }}>
              {EXPERT_CAPTURE_FUTURE_PLACEHOLDERS.map((p) => (
                <li key={p}>{p}</li>
              ))}
            </ul>
          </details>
  ...
  // interview phase (default)
  return (
    <div style={styles.page}>
      <div style={styles.container}>
        <header style={{ marginBottom: 20, borderBottom: '1px solid #e5e5e5', paddingBottom: 16 }}>
          <p style={{ margin: 0, fontSize: 13, color: '#a3a3a3' }}>Expert Capture Session</p>

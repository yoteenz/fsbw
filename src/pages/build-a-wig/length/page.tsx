  ...
  const handleConfirmSelection = () => {
    ...
    if (!sourceRoute) {
      ...
      if (editingCartItem) {
        ...
        console.log('Length page - No sourceRoute found, detected edit mode from localStorage');
      } else if (selectedCapSize) {
        sourceRoute = '/build-a-wig/noir/customize';
        console.log('Length page - No sourceRoute found, detected customize mode from localStorage');
      } else {
    ...
    <>
      ...
      <div className="min-h-screen" style={{
        ...
        <div className="relative z-10">
          ...
          {/* MAIN BUILD AREA */}
          <div
            className="border border-black flex flex-col pt-6 pb-4 px-5 bg-white/60 backdrop-blur-sm"
          ...
          >
            ...
            <div className="text-center">
              ...
              <p 
                ...
                style={{ fontFamily: '"Futura PT Medium", Futura, Futura, Inter, sans-serif', fontWeight: '500' }}
              >

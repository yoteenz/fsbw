  ...
  const handleConfirmSelection = () => {
    ...
    if (!sourceRoute) {
      ...
      if (editingCartItem) {
        ...
        console.log('Cap-size page - No sourceRoute found, detected edit mode from localStorage');
      } else if (selectedCapSize) {
        sourceRoute = '/build-a-wig/noir/customize';
        console.log('Cap-size page - No sourceRoute found, detected customize mode from localStorage');
      } else {

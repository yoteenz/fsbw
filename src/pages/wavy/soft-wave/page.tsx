                  ...
                  <div className="flex flex-col" style={{ height: 'clamp(290px, 72.5vw, 464px)', justifyContent: 'space-between', gap: 'clamp(6px, 1.2vw, 12px)' }}>
                    <div className="flex-shrink-0 relative">
                      <div
                        ...
                        style={{ width: 'clamp(100px, 26vw, 175px)', height: 'clamp(140px, 36vw, 245px)', backgroundImage: `url('/assets/${is3DView ? current3DImages.top : 'NOIR/leaf-brick.png'}')`, backgroundSize: 'cover', backgroundPosition: is3DView ? 'center calc(50% + 10px)' : 'center', backgroundRepeat: 'no-repeat' }}
                    ...
                    <div className="flex-shrink-0 relative">
                      <div
                        className="relative bg-cover flex items-center justify-center cursor-pointer"
                        style={{ width: 'clamp(100px, 26vw, 175px)', height: 'clamp(140px, 36vw, 245px)', backgroundImage: `url('/assets/${is3DView ? current3DImages.bottom : 'NOIR/leaf-brick.png'}')`, backgroundSize: 'cover', backgroundPosition: is3DView ? 'center calc(50% + 10px)' : 'center', backgroundRepeat: 'no-repeat' }}

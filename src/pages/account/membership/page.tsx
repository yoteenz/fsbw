...
import { BRAND_GRAY } from '../../../components/membership/premiumChartTable';
                ...
                {showLoyaltyRewards ? (
                  ...
                  showPremiumView ? (
                    <PremiumSubscriptionUpgradeChart
                      onClose={handleClosePremiumView}
                      hasPremiumSubscription={hasPremiumSubscription}
                      selectedTier={selectedTier}
                      setSelectedTier={setSelectedTier}
                      showAllBenefits={showPremiumUpgradeAllBenefits}
                      setShowAllBenefits={setShowPremiumUpgradeAllBenefits}

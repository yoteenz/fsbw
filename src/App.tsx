...
const AdminStudioPartnerAgency = lazyWithRetry(() => import('./pages/admin/studio/partner-agency/page'), 'AdminStudioPartnerAgency');
...
const AdminStudioProfessionSimulation = lazyWithRetry(() => import('./pages/admin/studio/profession-simulation/page'), 'AdminStudioProfessionSimulation');
...
const AdminStudioExperienceRuntime = lazyWithRetry(
...
const AdminStudioIntelligenceLayer = lazyWithRetry(
...
const AdminStudioExperienceLabV2 = lazyWithRetry(
  () => import('./pages/admin/studio/experience-lab-v2/page'),
  'AdminStudioExperienceLabV2'
);
const AdminStudioExperienceLabV3 = lazyWithRetry(
  () => import('./pages/admin/studio/experience-lab-v3/page'),
  'AdminStudioExperienceLabV3'
);
const AdminStudioWorldBuilder = lazyWithRetry(
...
const AdminStudioExperienceLabIconCropEditor = lazyWithRetry(
  () => import('./pages/admin/studio/experience-lab-icon-crop-editor/page'),
  'AdminStudioExperienceLabIconCropEditor'
);
const AdminStudioWorldIconGridCalibration = lazyWithRetry(
...
const AdminCreativeOperatingSystem = lazyWithRetry(
  () => import('./pages/admin/studio/creative-operating-system/page'),
  'AdminCreativeOperatingSystem'
);
...
const AdminStudioSelfHealingEngine = lazyWithRetry(
...
const AdminStudioOrganizationalGuardian = lazyWithRetry(
...
const AdminStudioVisualDiffEngine = lazyWithRetry(
...
const AdminStudioPerformanceMonitor = lazyWithRetry(
...
const AdminStudioReleaseReadiness = lazyWithRetry(
...
const AdminStudioIdentityGraph = lazyWithRetry(
...
const AdminStudioSkillGraph = lazyWithRetry(
...
const AdminStudioOrganizationalHierarchy = lazyWithRetry(
...
const AdminStudioWorldPath = lazyWithRetry(() => import('./pages/admin/studio/world/page'), 'AdminStudioWorldPath');
...
const AdminStudioExperienceObservatory = lazyWithRetry(
...
const AdminStudioConstitutionHall = lazyWithRetry(
...
const AdminStudioExchange = lazyWithRetry(
  () => import('./pages/admin/studio/studio-exchange/page'),
  'AdminStudioExchange'
);
const AdminStudioCodex = lazyWithRetry(
...
const AdminStudioHeadquartersPrinciples = lazyWithRetry(
...
const AdminStudioExecutiveHeadquarters = lazyWithRetry(
  () => import('./pages/admin/studio/executive-headquarters/page'),
  'AdminStudioExecutiveHeadquarters'
);
const AdminStudioFounderAcceptanceTesting = lazyWithRetry(
...
const AdminStudioInnovationDistrict = lazyWithRetry(
...
const AdminStudioInnovationConstellations = lazyWithRetry(
  () => import('./pages/admin/studio/innovation-constellations/page'),
  'AdminStudioInnovationConstellations'
);
const AdminStudioInnovationExpeditions = lazyWithRetry(
  () => import('./pages/admin/studio/innovation-expeditions/page'),
...
const AdminStudioVirtualProduction = lazyWithRetry(() => import('./pages/admin/studio/virtual-production/page'), 'AdminStudioVirtualProduction');
    ...
    <ErrorBoundary>
      ...
      <DebugModeShell>
        ...
        >
          ...
          <Route path="studio/world/*" element={
            <Suspense fallback={<LoadingScreen />}>
          ...
          <Route path="studio/ndxbook/newsroom/:departmentId" element={
            <Suspense fallback={<LoadingScreen />}>
              <AdminStudioNdxbookNewsroomDepartment />
            </Suspense>
          } />
          <Route path="studio/ndxbook/newsroom" element={
            <Suspense fallback={<LoadingScreen />}>
              <AdminStudioNdxbookNewsroom />
            </Suspense>
          } />
          ...
          <Route path="studio/partner-agency" element={
            <Suspense fallback={<LoadingScreen />}>
              <AdminStudioPartnerAgency />
            </Suspense>
          } />
          ...
          <Route path="studio/profession-simulation" element={
            <Suspense fallback={<LoadingScreen />}>
              <AdminStudioProfessionSimulation />
            </Suspense>
          } />
          ...
          <Route path="studio/experience-runtime/:roomSlug" element={
            <Suspense fallback={<LoadingScreen />}>
              <AdminStudioExperienceRuntime />
            </Suspense>
          } />
          <Route path="studio/brand-discovery-engine" element={
            <Suspense fallback={<LoadingScreen />}>
              <AdminStudioBrandDiscoveryEngine />
            </Suspense>
          } />
          <Route path="studio/brand-discovery-engine/:roomSlug" element={
            <Suspense fallback={<LoadingScreen />}>
              <AdminStudioBrandDiscoveryEngine />
            </Suspense>
          } />
          <Route path="studio/studio-intelligence-layer" element={
            <Suspense fallback={<LoadingScreen />}>
              <AdminStudioIntelligenceLayer />
            </Suspense>
          } />
          ...
          <Route path="studio/experience-lab/test-v2" element={
            <Suspense fallback={<StudioRouteSuspenseFallback label="Experience Lab V2 alias" />}>
              <AdminStudioExperienceLabTestV2Alias />
            </Suspense>
          } />
          <Route path="studio/experience-lab-v2" element={
            <Suspense fallback={<StudioRouteSuspenseFallback label="Experience Lab V2" />}>
              <AdminStudioExperienceLabV2 />
            </Suspense>
          } />
          <Route path="studio/experience-lab-v3" element={
            <Suspense fallback={<StudioRouteSuspenseFallback label="Experience Lab V3" />}>
              <AdminStudioExperienceLabV3 />
            </Suspense>
          } />
          ...
          <Route path="studio/creative-operating-system" element={
            <Suspense fallback={<LoadingScreen />}>
              <AdminCreativeOperatingSystem />
            </Suspense>
          } />
          <Route path="studio/creative-operating-system/:roomSlug" element={
            <Suspense fallback={<LoadingScreen />}>
              <AdminCreativeOperatingSystem />
            </Suspense>
          } />
          ...
          <Route path="studio/studio-exchange" element={
            <Suspense fallback={<LoadingScreen />}>
              <AdminStudioExchange />
            </Suspense>
          } />
          ...
          <Route path="studio/executive-headquarters" element={
            <Suspense fallback={<LoadingScreen />}>
              <AdminStudioExecutiveHeadquarters />
            </Suspense>
          } />
          <Route path="studio/executive-headquarters/:roomSlug" element={
            <Suspense fallback={<LoadingScreen />}>
              <AdminStudioExecutiveHeadquarters />
            </Suspense>
          } />
          ...
          <Route path="studio/innovation-constellations" element={
            <Suspense fallback={<LoadingScreen />}>
              <AdminStudioInnovationConstellations />
            </Suspense>
          } />
          <Route path="studio/innovation-expeditions" element={
            <Suspense fallback={<LoadingScreen />}>
              <AdminStudioInnovationExpeditions />
            </Suspense>
          } />
          ...
          <Route path="studio/virtual-production" element={
            <Suspense fallback={<LoadingScreen />}>
              <AdminStudioVirtualProduction />
            </Suspense>
          } />

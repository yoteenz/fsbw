...
const CARE_BULLETS = [
  ...
  'AVOID EXCESSIVE BRUSHING OR AGGRESSIVE DETANGLING NEAR THE HAIRLINE, AS THIS MAY WEAKEN THE LACE AND CONTRIBUTE TO PREMATURE SHEDDING OVER TIME.',
  ...
  'WHEN CUSTOMIZING YOUR UNIT, PLUCK CONSERVATIVELY. OVER-PLUCKING CAN CREATE THIN SPOTS, BALD AREAS OR PERMANENT DAMAGE TO THE LACE.',
  'AVOID EXCESSIVE TENSION DURING INSTALLATION, REMOVAL OR STYLING. PULLING OR STRETCHING THE LACE MAY CAUSE DISTORTION, TEARING OR IRREVERSIBLE DAMAGE.',
  'HANDLE THE LACE WITH CARE DURING WASHING AND MAINTENANCE. AGGRESSIVE SCRUBBING, HARSH PRODUCTS OR EXCESSIVE FRICTION MAY COMPROMISE THE INTEGRITY OF THE LACE OVER TIME.',
  'ALWAYS USE GENTLE PRESSURE WHEN REMOVING ADHESIVE, MAKEUP OR PRODUCT BUILDUP FROM THE LACE.',
...
const STORAGE_ITEMS = [
  ...
  'AVOID FOLDING, CRUSHING, OR STORING THE LACE UNDER PRESSURE TO HELP MAINTAIN ITS SHAPE AND STRUCTURAL INTEGRITY.',
] as const;

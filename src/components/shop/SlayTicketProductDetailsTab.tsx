...
const SLAY_TICKET_DETAILS_BULLETS = [
  ...
  'AVAILABLE IN 4, 8, 12, 24, 48, AND 60 TICKET PACKS AT $4 PER TICKET LIST RATE.',
  'LARGER PACKS INCLUDE VOLUME SAVINGS (8 FOR $30, 12 FOR $46, 24 FOR $90, 48 FOR $180, 60 FOR $225).',
  'USE TICKETS TO UNLOCK INDIVIDUAL LOUNGE TV CONTENT ITEMS FROM YOUR ACCOUNT.',
  'QUALIFYING FRONTAL SLAYER HAIR PURCHASES INCLUDE COMPLIMENTARY CARE EDUCATION RELEVANT TO YOUR PRODUCT — NOT BONUS SLAY TICKETS.',

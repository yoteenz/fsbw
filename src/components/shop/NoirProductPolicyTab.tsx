  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
      ...
      <p style={BODY_STYLE}>
        ...
        <span style={EMAIL_STYLE}>CONTACT@FRONTALSLAYER.COM</span> WITH YOUR ORDER NUMBER AND CLEAR PHOTOS/VIDEOS OF THE ISSUE FOR REVIEW.
      </p>
      ...
      <p style={BODY_STYLE}>
        BY COMPLETING YOUR PURCHASE, YOU ACKNOWLEDGE THAT YOU HAVE REVIEWED AND AGREED TO OUR FULL TERMS OF SERVICE, PROCESSING POLICY AND REFUND POLICY.
      </p>

      <p style={BODY_STYLE}>FOR ASSISTANCE, PLEASE CONTACT:</p>
      <p style={EMAIL_STYLE}>CONTACT@FRONTALSLAYER.COM</p>

...
export default function NoirProductPolicyTab() {
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
      <p style={BODY_STYLE}>
        DUE TO THE SANITARY NATURE OF HAIR PRODUCTS, PRODUCT CUSTOMIZATION AND LIMITED INVENTORY AVAILABILITY, ALL SALES ARE FINAL. WE ARE UNABLE TO OFFER REFUNDS, RETURNS OR EXCHANGES ONCE AN ORDER HAS BEEN PLACED AND CONFIRMED.
      </p>

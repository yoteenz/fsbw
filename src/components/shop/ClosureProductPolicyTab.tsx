/** BCF closures PDP — POLICY tab (matches NOIR tab typography + markers). */
...
export default function ClosureProductPolicyTab() {
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
      ...
      <p style={BODY_STYLE}>
        BECAUSE OUR CLOSURES ARE CRAFTED USING AUTHENTIC RAW HUMAN HAIR, SLIGHT VARIATIONS MAY OCCUR IN:
      </p>
      ...
      <p style={BODY_STYLE}>
        THESE NATURAL CHARACTERISTICS ARE EXPECTED AND ARE NOT CONSIDERED DEFECTS. NO TWO CLOSURES ARE GUARANTEED TO BE IDENTICAL, WHICH CONTRIBUTES TO THE AUTHENTICITY AND UNIQUENESS OF EACH PIECE.
      </p>

...
export default function NoirProductShippingTab() {
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
      ...
      <p style={BODY_STYLE}>
        STANDARD PROCESSING FOR READY TO WEAR UNITS IS APPROXIMATELY 6-8 WEEKS. UNITS THAT INCLUDE CUSTOMIZATION SERVICES SUCH AS CUSTOM COLOR, KNOT BLEACHING, PLUCKING, STYLING, CUTTING, LAYERING OR ADDITIONAL MODIFICATIONS MAY REQUIRE UP TO 10 WEEKS FOR COMPLETION.
      </p>

      <p style={SECTION_TITLE_STYLE}>express processing</p>
      <p style={BODY_STYLE}>
        NEED YOUR UNIT TO HIT YOUR DOORSTEP SOONER? WE OFFER EXPRESS PROCESSING AND RUSH SHIPPING FOR AN ADDITIONAL $120 USD. ELIGIBLE UNITS ARE PRIORITIZED IN OUR PRODUCTION QUEUE AND PROCESSED WITHIN APPROXIMATELY 4-6 WEEKS.
      </p>
      ...
      <p style={BODY_STYLE}>
        FROM SOURCING TO FINAL QUALITY CONTROL, EVERY UNIT AND EXTENSION UNDERGOES A CAREFUL REVIEW PROCESS TO CONFIRM IT MEETS FRONTAL SLAYER STANDARDS. WE PRIORITIZE EXCEPTIONAL CRAFTSMANSHIP OVER RUSHED PRODUCTION TO ENSURE YOUR RAW EXTENSIONS ARRIVE READY TO MAKE A STATEMENT THE MOMENT IT TOUCHES YOUR HEAD.
      </p>
    </div>
  );
}

...
export default function NoirProductShippingTab() {
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
      ...
      <p style={BODY_STYLE}>
        UNITS AND EXTENSIONS ARE INDIVIDUALLY CRAFTED, INSPECTED AND PREPARED TO MEET OUR QUALITY STANDARDS. WE PRIORITIZE EXCEPTIONAL CRAFTSMANSHIP OVER RUSHED PRODUCTION TO ENSURE YOUR UNIT ARRIVES READY TO MAKE A STATEMENT THE MOMENT IT TOUCHES YOUR HEAD.
      </p>
    </div>
  );
}

/** BCF bundles PDP — POLICY tab (matches NOIR tab typography + markers). */
...
export default function BundleProductPolicyTab() {
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
      <p style={SECTION_TITLE_STYLE}>purchase policy</p>
      <p style={BODY_STYLE}>
        DUE TO THE SANITARY NATURE OF HAIR PRODUCTS, THE PREMIUM SOURCING OF OUR RAW HAIR AND LIMITED INVENTORY AVAILABILITY, ALL BUNDLE SALES ARE FINAL. WE ARE UNABLE TO OFFER REFUNDS, RETURNS OR EXCHANGES ONCE AN ORDER HAS BEEN PLACED AND CONFIRMED. WE STRONGLY ENCOURAGE CLIENTS TO REVIEW ALL PRODUCT DETAILS, TEXTURE SELECTIONS, LENGTHS, ORIGINS, PROCESSING TIMELINES AND POLICIES BEFORE COMPLETING THEIR PURCHASE.
      </p>
      ...
      <p style={BODY_STYLE}>
        BECAUSE OUR EXTENSIONS ARE CRAFTED FROM AUTHENTIC RAW HUMAN HAIR, SLIGHT VARIATIONS MAY OCCUR IN:
      </p>
      ...
      <p style={BODY_STYLE}>
        THESE NATURAL CHARACTERISTICS ARE EXPECTED AND ARE NOT CONSIDERED DEFECTS. NO TWO BUNDLES ARE GUARANTEED TO BE IDENTICAL, WHICH IS PART OF WHAT MAKES RAW HAIR SO UNIQUE.
      </p>

      <p style={SECTION_TITLE_STYLE}>processing & communication</p>
      <p style={BODY_STYLE}>
        FINAL PROCESSING TIMELINES MAY VARY BASED ON ORDER VOLUME, INVENTORY AVAILABILITY, CUSTOMIZATION REQUESTS, HOLIDAYS AND PROMOTIONAL PERIODS. ORDER UPDATES, SHIPPING CONFIRMATIONS AND TRACKING INFORMATION WILL BE SENT TO THE EMAIL ADDRESS PROVIDED AT CHECKOUT. CUSTOMERS ARE RESPONSIBLE FOR ENSURING ALL CONTACT AND SHIPPING INFORMATION IS ACCURATE BEFORE SUBMITTING THEIR ORDER.
      </p>

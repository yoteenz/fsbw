              ...
              {showDebugFrames ? (
                <div className="flex flex-col gap-3 border border-black/15 p-3">
                  <p className="text-[9px] uppercase tracking-[0.12em] text-[#808080] leading-relaxed">
                    ...
                    Generate uses GPT Image 2 for photos, TOP MATCH specs, overall score %, and stars; server overlays symmetrical client-photo bottom fade and MATCH 02–04 row values.
                  </p>

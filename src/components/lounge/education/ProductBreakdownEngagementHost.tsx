...
type ProductBreakdownEngagementHostProps = {
...
export function ProductBreakdownEngagementHost({
  pack,
  contentTitle,
  readTimeLabel,
  onRequireSignIn,
  ...
  userEmail = null,
  engagementToast,
}: ProductBreakdownEngagementHostProps) {
  ...
  return (
    <>
      {!discussionOpen ? (
        <div className="lounge-tv-product-breakdown-editorial__engagement-wrap">
          <p className="lounge-tv-product-breakdown-editorial__helpful-prompt">

...
import {
  buildUnitCartViewDetailsHtml,
  unitCartItemHasViewDetails,
  unitCartViewDetailsLineCount,
} from '../utils/unitCartViewDetails';
...
function cartDropdownDetailTextRowCount(item: CartItem): number {
  ...
  return unitCartViewDetailsLineCount(item);
}
                   ...
                   >
                      ...
                      >
                        ...
                        {viewingDetailsFor === item.id && (
                          ...
                          return buildUnitCartViewDetailsHtml(item, selectedCurrency);
                          })()
                        }}
                          />
                          </CartLineTextLayer>
                  ...
                  {/* Remove Button */}
                    ...
                    >
                      ...
                      {(() => {
                        ...
                        if (!unitCartItemHasViewDetails(item)) {

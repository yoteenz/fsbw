...
export function OrganizationalWorkflowOrchestrationLinkPanel() {
  return (
    <section className="p-3 mb-3" style={{ ...cosPanel, borderLeft: '4px solid #0EA5E9' }}>
      <p style={cosSectionTitle}>ORGANIZATIONAL WORKFLOW ORCHESTRATION · CROSS-FUNCTIONAL CHOREOGRAPHY V1.0</p>
      <p style={cosLabel}>
        Coordinated teams · not disconnected automations · Chief of Staff conducts organizational execution
      </p>
      <Link
        to={adminStudioOrganizationalWorkflowOrchestrationPath()}
        style={{ ...cosLabel, color: '#0EA5E9', fontFamily: '"Futura PT Medium"', display: 'inline-block', marginTop: 8 }}
      >
        → OPEN ORGANIZATIONAL WORKFLOW ORCHESTRATION
      </Link>
    </section>
  );
}

export function OrganizationalSelfImprovementLinkPanel() {
  return (
    <section className="p-3 mb-3" style={{ ...cosPanel, borderLeft: '4px solid #10B981' }}>
      <p style={cosSectionTitle}>ORGANIZATIONAL SELF-IMPROVEMENT · CONTINUOUS EVOLUTION V1.0</p>
      <p style={cosLabel}>
        The organization reflects · learns · and strengthens itself · learning compounds every day
      </p>
      <Link
        to={adminStudioOrganizationalSelfImprovementPath()}
...
export function LeadershipModesLinkPanel() {
  return (
    <section className="p-3 mb-3" style={{ ...cosPanel, borderLeft: '4px solid #4F46E5' }}>
      <p style={cosSectionTitle}>LEADERSHIP MODES · FOUNDER & EXECUTIVE MODE V1.0</p>
      <p style={cosLabel}>
        How do you want to lead today? · same organization · different perspective · zero context lost
      </p>
      <Link
        to={adminStudioLeadershipModesPath()}
        style={{ ...cosLabel, color: '#4F46E5', fontFamily: '"Futura PT Medium"', display: 'inline-block', marginTop: 8 }}
      >
        → OPEN LEADERSHIP MODES
      </Link>
    </section>
  );
}

export function CompanyOnboardingIntelligenceLinkPanel() {
  return (
    <section className="p-3 mb-3" style={{ ...cosPanel, borderLeft: '4px solid #0D9488' }}>
      <p style={cosSectionTitle}>COMPANY ONBOARDING INTELLIGENCE · ORGANIZATIONAL WELCOME V1.0</p>
      <p style={cosLabel}>
        Discover the organization&apos;s story · arrive at headquarters · feel understood before managing
      </p>
      <Link
        to={adminStudioCompanyOnboardingIntelligencePath()}
        style={{ ...cosLabel, color: '#0D9488', fontFamily: '"Futura PT Medium"', display: 'inline-block', marginTop: 8 }}
      >
...
export function ExecutiveApprenticeshipLinkPanel() {
  return (
    <section className="p-3 mb-3" style={{ ...cosPanel, borderLeft: '4px solid #7C3AED' }}>
      <p style={cosSectionTitle}>EXECUTIVE APPRENTICESHIP & FOUNDER CALIBRATION V1.0</p>
      <p style={cosLabel}>
        Observe · learn · practice · calibrate · trust earned never assumed · amplify founder leadership
      </p>
      <Link
        to={adminStudioExecutiveApprenticeshipFounderCalibrationPath()}
        style={{ ...cosLabel, color: '#7C3AED', fontFamily: '"Futura PT Medium"', display: 'inline-block', marginTop: 8 }}
      >
        → OPEN EXECUTIVE APPRENTICESHIP
      </Link>
    </section>
  );
}

export function StudioInstituteLinkPanel() {
  return (
    <section className="p-3 mb-3" style={{ ...cosPanel, borderLeft: '4px solid #854D0E' }}>
      <p style={cosSectionTitle}>STUDIO INSTITUTE · PERMANENT LEARNING INSTITUTION V1.0</p>
      <p style={cosLabel}>
        Organizational education · schools of excellence · executive faculty · wisdom compounding daily
      </p>
      <Link
        to={adminStudioStudioInstitutePath()}
        style={{ ...cosLabel, color: '#854D0E', fontFamily: '"Futura PT Medium"', display: 'inline-block', marginTop: 8 }}
      >
        → OPEN STUDIO INSTITUTE
      </Link>
    </section>
  );
}

export function OrganizationalApprenticeshipLinkPanel() {
  return (
    <section className="p-3 mb-3" style={{ ...cosPanel, borderLeft: '4px solid #155E75' }}>
      <p style={cosSectionTitle}>ORGANIZATIONAL APPRENTICESHIP · STEWARDSHIP & EARNED TRUST V1.0</p>
      <p style={cosLabel}>
        Every new intelligence apprentices first · observe · understand · practice · earn trust · Chief of Staff stewards mentorship
      </p>
      <Link
        to={adminStudioOrganizationalApprenticeshipPath()}

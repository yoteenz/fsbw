...
export function VisualDiffEngineWorkspace() {
  ...
  const renderOverview = () => (
    <ExecutivePageShell>
      ...
      <button type="button" onClick={() => navigate(adminStudioAccessibilityAuditorPath())} className="mt-2 px-2 py-1 text-[6px] font-futura uppercase border" style={{ borderColor: ADMIN_STUDIO_THEME.panelBorder, color: ADMIN_STUDIO_THEME.textSecondary }}>

...
export const DOCUMENTATION_PAGE_GUIDE_OVERRIDES: Partial<Record<string, PageGuideOverride>> = {
  ...
  'knowledge-registry': fromSystem('knowledge-registry'),
  'documentation-registry': fromSystem('knowledge-registry'),
  ...
  'role-intelligence': fromSystem('role-intelligence'),
  'organizational-hierarchy': fromSystem('organizational-hierarchy'),
  'identity-timeline': fromSystem('identity-timeline'),

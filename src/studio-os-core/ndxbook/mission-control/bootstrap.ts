...
function buildDemoNdxbookMissionControlSeed(): Partial<NdxbookMissionControlStore> {
  ...
  return {
    ...
    companyHealth: [
      { id: 'overall', label: 'OVERALL COMPANY HEALTH', score: 94, trend: 'up', trendLabel: '+4% vs last week' },
    ...
    missionActions: [
      ...
      { id: 'create-page', label: 'START PROJECT', route: '/admin/studio/ndxbook?tab=pages', priority: 2, frequencyScore: 90 },

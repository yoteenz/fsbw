...
export const STUDIO_WORLD_NAVIGATION_EDGES: StudioWorldNavigationEdge[] = [
  ...
  { fromLocationId: 'archives-innovation-constellations', toLocationId: 'archives-innovation-expeditions', movementVerb: 'walk', label: 'Walk to Innovation Expeditions™' },
  { fromLocationId: 'archives-innovation-expeditions', toLocationId: 'archives-innovation-district', movementVerb: 'walk', label: 'Walk to Innovation District™' },

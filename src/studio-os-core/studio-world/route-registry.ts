...
export const STUDIO_WORLD_ROUTE_REGISTRY: StudioWorldRouteMapping[] = [
  ...
  m('world-atlas', 'Mission Control™', 'observatory', 'studio-command-center', 'scc-executive-district', 'command-center/executive-district/world-atlas', 'world-atlas', 'immersive', 'immersive-partial', 'Mission Control'),

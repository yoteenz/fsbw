...
export function syncDockContext(pathname: string): DockContextProfile {
  ...
  const proactiveSource =
    ambientOpening
      ...
      : pathname.includes('/knowledge-hub') && documentationRegistryProactive
      ? documentationRegistryProactive

...
export const CODEX_SEMANTIC_CLUSTERS: CodexSemanticCluster[] = [
  ...
  },
  {
    ...
    relatedArticleIds: ['ARTICLE-W01', 'ARTICLE-W02', 'ARTICLE-W07', 'ARTICLE-C04'],
  ...
  },
  {
    ...
    relatedArticleIds: ['ARTICLE-C04', 'ARTICLE-C01', 'ARTICLE-W01', 'ARTICLE-D09'],
    relatedSystems: ['Headquarters™', 'Atlas™', 'Orb™', 'Mission Control™'],
    relatedVolumes: ['volume-ii-constitution', 'volume-iii-world-bible'],
  },
  {
    id: 'proof-before-expansion-cluster',
    triggers: [
    ...
    relatedArticleIds: ['ARTICLE-C04', 'ARTICLE-A02', 'ARTICLE-C03', 'ARTICLE-E05', 'ARTICLE-E02', 'ARTICLE-E04', 'ARTICLE-B01', 'ARTICLE-K24'],
    relatedSystems: ['Studio Foundry™', 'Institute of Knowledge™', 'Studio Exchange™', 'Career Worlds™', 'Professional Memory™'],
    relatedVolumes: ['volume-ii-constitution', 'volume-viii-career-worlds', 'volume-vi-production-standards'],
  },
  {
    id: 'institute-of-knowledge-cluster',
    triggers: [
    ...
    relatedArticleIds: ['ARTICLE-C03', 'ARTICLE-C04', 'ARTICLE-C02', 'ARTICLE-K22', 'ARTICLE-K23', 'ARTICLE-B04'],
    relatedSystems: ['Institute of Knowledge™', 'Knowledge Core™', 'Profession Brains™', 'Orb™'],
    relatedVolumes: ['volume-ii-constitution', 'volume-ix-knowledge-core'],
  },
  {

...
const RELATIONSHIP_SEEDS: RelSeed[] = [
  ...
  { from: 'ARTICLE-C04', to: 'ARTICLE-C01', type: 'supports', label: 'principles-before-expansion-law' },
  { from: 'ARTICLE-C04', to: 'ARTICLE-C02', type: 'supports', label: 'collections-expand-after-proof' },
  { from: 'ARTICLE-C04', to: 'ARTICLE-C03', type: 'supports', label: 'institute-proves-studio-os-first' },
  { from: 'ARTICLE-C04', to: 'ARTICLE-A02', type: 'supports', label: 'foundry-first-builds-studio-os' },
  { from: 'ARTICLE-C04', to: 'ARTICLE-E02', type: 'supports', label: 'career-worlds-prove-in-academy' },
  { from: 'ARTICLE-C04', to: 'ARTICLE-E04', type: 'supports', label: 'professional-memory-founder-proof' },
  { from: 'ARTICLE-C04', to: 'ARTICLE-E05', type: 'supports', label: 'exchange-internal-before-public' },
  { from: 'ARTICLE-C04', to: 'ARTICLE-B01', type: 'supports', label: 'profession-brains-operate-frontal-slayer-first' },
  { from: 'ARTICLE-C04', to: 'ARTICLE-K24', type: 'depends-on', label: 'proof-requires-completion-metrics' },

...
function buildInfrastructureEntries(): SystemRegistryEntry[] {
  const entries: SystemRegistryEntry[] = [
    ...
    baseEntry({
      ...
      description: 'Tenant-scoped organization instance — all module profiles keyed by workspace ID. Carries Release Channel assignment per CA-001.',
      category: 'organization',
      dependencies: ['service:organization-context', 'module:release-channel-system'],
      status: 'live',
      version: '1.1.0',
      documentation: ['docs/studio-os/workspace-system.md', 'docs/studio-os/release-channel-system.md'],
      relatedSystems: ['module:release-channel-system', 'module:organization-genome'],
    }),
    baseEntry({
      uniqueId: 'infrastructure:release-channel-system',
      officialName: 'Studio OS Release Channel System™',
      description:
        'Constitutional operating channels (Stable, Preview, Beta, Experimental) governing organization capability adoption. CA-001.',
      category: 'service',
      dependencies: ['module:system-registry', 'module:knowledge-registry', 'module:organization-genome'],
      status: 'live',
      version: 'M127.14',
      moduleId: 'release-channel-system',
      milestone: 'M127.14',
      relatedSystems: [
        'module:qa-headquarters',
        'module:release-readiness',
        'module:manifest-reconciliation',
        'module:documentation-sync',
      ],
      documentation: [
        'docs/studio-os/release-channel-system.md',
        'docs/studio-os/master-spec/release-channel-system.yaml',
      ],
      keywords: ['release channel', 'stable', 'preview', 'beta', 'experimental', 'CA-001'],
      aliases: ['Release Channel System', 'Operating Channels'],
    }),
    baseEntry({
      uniqueId: 'engine:qa-engine',
      officialName: 'QA Engine™',
      description: 'Channel-native QA validation — enforces per-channel gates before module exposure.',
      category: 'service',
      dependencies: ['infrastructure:release-channel-system', 'module:qa-headquarters', 'module:release-readiness'],
      status: 'live',
      version: '1.1.0',
      relatedSystems: ['module:qa-inspector', 'module:qa-simulation-engine'],
    }),
    baseEntry({
      uniqueId: 'engine:update-engine',
      officialName: 'Update Engine™',
      description: 'Channel-staged manifest and documentation rollout — Preview/Beta before Stable.',
      category: 'service',
      dependencies: ['infrastructure:release-channel-system', 'module:manifest-reconciliation', 'module:documentation-sync'],
      status: 'live',
      version: '1.1.0',
      relatedSystems: ['module:knowledge-registry'],
    }),
    baseEntry({
      uniqueId: 'engine:deployment-engine',
      officialName: 'Deployment Engine™',
      description: 'Channel-scoped deployment promotion — Stable requires Release Readiness™ approval.',
      category: 'service',
      dependencies: ['infrastructure:release-channel-system', 'module:release-readiness', 'module:documentation-governance'],
      status: 'live',
      version: '1.1.0',
      relatedSystems: ['module:self-healing-engine'],
    }),
    baseEntry({

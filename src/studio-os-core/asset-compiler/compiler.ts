...
export function buildCompiledAssetMetadata(
  ...
  const assetId = `asset-${recipe.id}-${safeName}`;
  ...
  return {
    ...
    registryLibrary: recipe.metadata.registryLibrary,
    storagePath,
  };
}
...
export function buildAssetRegistryEntry(metadata: CompiledAssetMetadata): RegisteredAssetEntry {
  return {
    ...
    tags: metadata.tags,
    description: `${metadata.registryLibrary} asset generated by Asset Compiler™ using ${metadata.recipe}.`,

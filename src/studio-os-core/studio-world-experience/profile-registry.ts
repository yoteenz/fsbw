...
export const STUDIO_WORLD_EXPERIENCE_PROFILES: ExperienceProfile[] = [
  ...
  },
  {
    ...
    primaryStory: 'Every destination is one civilization.',
    primaryQuestion: 'Where do I go?',
    primaryOrbMode: 'navigation',
    defaultPresenceLevel: 0,
    ambientInformation: ['Current Location', 'Nearby Districts'],
    contextModules: ['Quick Travel™', 'Bookmarks™', 'Pinned Destinations™'],
    deepSystems: ['World Graph™', 'Flagship Registry™'],

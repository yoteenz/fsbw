...
export const PRODUCTION_DEPARTMENTS: ProductionDepartmentDef[] = [
  {
    ...
    prerequisites: 'An idea or campaign slot exists (Page 001 pilot is pre-assigned).',
  },
  {
    id: 'development',
    number: 2,
  ...
  },
  {
    ...
    purpose: 'Create Page 001 — the Master Content Asset — in the production studio.',
  ...
  },
  {
    ...
    purpose: 'Publish or schedule Page 001 to Instagram.',

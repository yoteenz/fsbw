...
export function ingestProfessionalMemoryWisdomNodes(): { nodes: WorldNode[]; edges: WorldEdge[] } {
  ...
  for (const memory of LAUNCH_PROFESSIONAL_MEMORIES) {
    ...
    nodes.push({
      ...
      tags: ['professional-memory', 'wisdom-engine', memory.category, memory.profession],
      implementationStatus: 'live',
      codePaths: ['src/studio-os-core/professional-memory-wisdom-engine/memory-events/catalog.ts'],
      docPaths: [

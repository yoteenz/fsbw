...
export const ISOLATED_ASSET_PROMPT_CONTRACT_VERSION = 'isolated-asset-prompt.v2';
...
export function buildSignatureLandmarkPrompt(input: {
  ...
  const prompt = [
    ...
    'REFERENCE RESTRICTION: No environment image is supplied. Use placement metadata only for viewing angle, perspective, approximate scale, orientation, and light direction. Do not reproduce, redraw, extend, repaint, imitate, preserve, or include any visual content from any reference environment.',
    ...
    'FORBIDDEN CONTENT: room · interior · office · lobby · hallway · walls · ceiling · floor · windows · doors · architecture · background · environment · ambient room lighting · complete composition · wide shot · cinematic environment · scene reconstruction · shell recreation · people · text · watermark · checkerboard background.',
  ...
  return {
    ...
    promptBuilderId: 'signature-landmark-isolated-prompt.v2',
...
export function buildFurnitureObjectsPrompt(input: {
  ...
  const prompt = [
    ...
    'REFERENCE RESTRICTION: No environment image supplied. Placement metadata only. Do not reproduce any room architecture or reference environment.',
    ...
    'FORBIDDEN CONTENT: room · interior · architecture · floor · ceiling · walls · windows · environment · wide shot · complete composition · scene reconstruction.',
  ...
  return {
    prompt,
    negativePrompt: ISOLATED_NEGATIVE_PROMPT,
    promptBuilderId: 'furniture-objects-isolated-prompt.v2',

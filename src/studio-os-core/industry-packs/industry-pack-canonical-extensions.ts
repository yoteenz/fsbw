...
export const CANONICAL_INDUSTRY_PACK_EXTENSIONS: IndustryPack[] = [
  extensionPack(
    ...
    'Neutral beauty brand headquarters — showroom, consultation, fulfillment',
    'beauty',
    [
      slot('reception', 'reception', 'v6', 'Reception', 'ground'),
      slot('lobby', 'lobby', 'v4', 'Lobby', 'ground', ['reception']),
      slot('showroom', 'retail-boutique', 'v2', 'Product Showroom', 'ground', ['lobby']),
      slot('consultation', 'treatment-room', 'v3', 'Consultation Room', 'first', ['showroom']),
      ...
      slot('fulfillment', 'storage', 'v2', 'Fulfillment / Shipping', 'basement', ['inventory']),
      slot('customer-lounge', 'waiting-area', 'v3', 'Customer Lounge', 'ground', ['reception']),
      slot('content-studio', 'studio-floor', 'v2', 'Content Studio', 'first', ['showroom']),
      slot('photography', 'photo-studio', 'v2', 'Photography Studio', 'first', ['content-studio']),
      slot('training', 'training-room', 'v4', 'Training Room', 'first', ['private-office']),
      slot('storage', 'storage', 'v2', 'Storage', 'basement', ['inventory']),
      slot('customer-service', 'office', 'v9', 'Customer Service', 'first', ['reception']),
      slot('checkout', 'checkout', 'v2', 'Checkout / Commerce', 'ground', ['showroom']),
      slot('product-development', 'studio-floor', 'v2', 'Product Development', 'first', ['inventory']),
    ]
  ),

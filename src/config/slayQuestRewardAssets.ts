...
export const slayQuestRewardAssets: Record<SlayQuestRewardType, SlayQuestRewardAssetConfig> = {
  loyalty_points: {
    ...
    phase1Url: 'REPLACE_WITH_SUPABASE_URL_LOYALTY_PHASE_1',
    phase2Url: 'REPLACE_WITH_SUPABASE_URL_LOYALTY_PHASE_2',
    phase3Url: 'REPLACE_WITH_SUPABASE_URL_LOYALTY_PHASE_3',

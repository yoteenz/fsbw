...
### AI Context Capsule™
Portable export bundle for external AI onboarding. **This folder** (`StudioOS_ContextCapsule_v0.1`) is the v0.1 manual prototype. Future: single `.studiocapsule` ZIP per `docs/ai-collaboration/AI_CONTEXT_CAPSULE_SPECIFICATION.md`.

### AI Context Protocol™
Universal standard for transferring institutional memory to any AI — bootstrap, health, memory graph, decision memory, canon engine, onboarding report, knowledge diff, AI Passport. Spec: `docs/ai-collaboration/AI_CONTEXT_PROTOCOL_SPECIFICATION.md`.

### Studio AI™
Persistent intelligence layer of Studio OS — not an LLM. Foundation models are interchangeable reasoning engines; Studio AI owns identity, roles, persona, and memory continuity. Spec: `docs/studio-os/studio-ai/`.

### Institutional Memory Engine™ (IME)
Platform system that generates, preserves, and evolves AI Context Capsules — primary asset is accumulated understanding, not prompts or chat logs.

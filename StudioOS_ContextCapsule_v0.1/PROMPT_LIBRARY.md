# Prompt Library™ — Reusable Structures
...
Founder uploads **StudioOS_ContextCapsule_v0.1** folder (or reads README_FIRST.md) and says:

```
I uploaded the AI Context Capsule v0.1.
